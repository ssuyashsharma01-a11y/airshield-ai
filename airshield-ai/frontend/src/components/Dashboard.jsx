...
export default function Dashboard({ user, onLogout }) {
  ...
  const lang = i18n?.language?.slice(0, 2) || 'en';
    ...
    alert("Audit Summary: Telemetry synced with CPCB standards. Exposure report cached successfully.");
  };
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8 font-sans " print:hidden>
      ...
      <div className="print:block text-slate-900 bg-white p-6 font-sans">
        <div className="audit-report-sheet hidden print:block flex justify-between items-start border-b-2 border-sky-600 pb-3 mb-4">
          <div>
